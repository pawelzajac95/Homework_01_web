        ...
        if action == 'c':
            while True:
                ...
                if contact_action == 'add':
                    ...
                    book.edit_record()
                    user_interface.display_message("Zaktualizowano kontakt.")
            ...
            while True:
                ...
                if note_action == 'add':
                    ...
                    notebook.edit_note()
                    user_interface.display_message("Zaktualizowano notatkę.")
            ...
            user_interface.display_message("Nieznana akcja, spróbuj ponownie.")
